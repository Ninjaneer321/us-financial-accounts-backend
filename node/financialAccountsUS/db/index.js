...
class FinancialAccountsUSDadabaseInterface {
        ...
        return new Promise((resolve, reject) => {
            ...
            fetch(url, {
                ...
                if (response.ok) {
                    ...
                    this.db.datesByTable.add({data_table_id: data_table_id, dates: dates})
                    reslove(dates)
                } else {
                    reject(new Error(response.json().msg))
                }
    ...
    getDataBySymbol(tableId, symbolId) {
        ...
        let entires = new Promise((resolve, reject) => {
            // TODO caching.
            let url = 'api/table/entries/by_symbol/'+symbolId
            fetch(url, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json'
...
global.financialAccountsUSDadabaseInterface_132 = global.financialAccountsUSDadabaseInterface_132 || 
                                                FinancialAccountsUSDadabaseInterface();                                               
...
const test = () => {
    let db = global.financialAccountsUSDadabaseInterface_132 
